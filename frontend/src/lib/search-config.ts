...
import {
  ...
  CalendarCheck, MapPin, Layers, Palette, FileText, type LucideIcon,
} from "lucide-react";
...
export const SEARCH_ITEMS: SearchItem[] = [
  ...
  { key: "destinations", label: "Destinations", section: "Products", keywords: ["destination", "country", "region", "travel", "master"], icon: MapPin },
