...
export const SEARCH_ITEMS: SearchItem[] = [
  ...
  { key: "activities", label: "Activities", section: "Products", keywords: ["activity", "tour", "experience"], icon: Activity },
  { key: "transfers", label: "Transfers", section: "Products", keywords: ["transfer", "vehicle", "pickup"], icon: Activity },
