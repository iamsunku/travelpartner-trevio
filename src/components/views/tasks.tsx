      ...
      <DialogContent className="sm:max-w-[520px]">
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            <Input placeholder="e.g. Follow up with customer for payment" />
          </div>
          <div className="space-y-1.5">
            <Label>Description</Label>
            <Textarea placeholder="Add context, links, or instructions..." rows={3} />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label>Assignee</Label>
              <Select defaultValue="Sneha Reddy">
            ...
            <div className="space-y-1.5">
              ...
              <Input type="date" defaultValue="2025-01-28" />
            </div>
            <div className="space-y-1.5">
              <Label>Related To (optional)</Label>
              <Input placeholder="BK-XXXX / LD-X" />
            </div>
          </div>
        </div>
        <DialogFooter>
