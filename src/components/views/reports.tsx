...
export function ReportsView() {
  ...
  const totalBookings = REVENUE_DATA.reduce((s, r) => s + r.bookings, 0);
  const totalCommission = REVENUE_DATA.reduce((s, r) => s + r.commission, 0);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={240}>
                  <PieChart>
                    <Pie data={PAYMENT_METHOD_DATA} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={85} label={(e: any) => `${e.name}`} labelLine={false} style={{ fontSize: 10 }}>
